...
public final class TerraVeraCreativeTab
{
    ...
    public static void onBuildTabContents(BuildCreativeModeTabContentsEvent event)
    {
        ...
        event.accept(TerraVeraItems.SODIS_RACK.get());
        event.accept(TerraVeraItems.BIO_SAND_FILTER.get());
        event.accept(TerraVeraItems.DISTILLATION_STILL.get());
        event.accept(TerraVeraItems.UV_STERILIZER.get());
        event.accept(TerraVeraItems.CLARIFIER.get());
        ...
        event.accept(TerraVeraItems.CLOTH_FILTER.get());
        event.accept(TerraVeraItems.BOILING_STONES.get());
        event.accept(TerraVeraItems.UNFIRED_CERAMIC_FILTER_CANDLE.get());
        event.accept(TerraVeraItems.CERAMIC_FILTER_CANDLE.get());
        event.accept(TerraVeraItems.MORINGA_SEED_POWDER.get());
        event.accept(TerraVeraItems.ALUM_CRYSTALS.get());
        event.accept(TerraVeraItems.CITRUS_JUICE.get());
        event.accept(TerraVeraItems.IODINE_DROPS.get());
        event.accept(TerraVeraItems.PERMANGANATE_CRYSTALS.get());
        event.accept(TerraVeraItems.CHLORINE_TABLETS.get());
        event.accept(TerraVeraItems.COLLOIDAL_SILVER.get());
        event.accept(TerraVeraItems.RO_MEMBRANE.get());
